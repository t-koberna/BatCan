...
class electrode():
    ...
    def __init__(self, input_file, inputs, sep_inputs, counter_ed_inputs,
        ...
        #if params['C-rate'] is not None: ############################################################ added this, not sure if another version is needed when setting i_ext
        ...
        #print(self.name)
        #print(init_spec_i)
        #print(self.conversion_surf_obj[init_spec_i].product_stoich_coeffs()[-1,:])
        #print(self.conversion_tpb_obj[init_spec_i].product_stoich_coeffs())
        prod_stoich = \
